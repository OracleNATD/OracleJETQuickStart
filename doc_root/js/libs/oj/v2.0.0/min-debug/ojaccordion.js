...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojcollapsible"], function($oj$$59$$, $$$$54$$) {
  (function() {
    $oj$$59$$.$__registerWidget$("oj.ojAccordion", $$$$54$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{multiple:!1, expanded:null, beforeExpand:null, expand:null, beforeCollapse:null, collapse:null}, _ComponentCreate:function() {
    ...
    }, _setOption:function($key$$161$$, $value$$283$$, $flags$$51$$) {
      if ("multiple" === $key$$161$$) {
      ...
      this._super($key$$161$$, $value$$283$$, $flags$$51$$);
    }, refresh:function() {
      this._super();
      this.$_refresh$();
    }, $_refresh$:function() {
      ...
      var $result$$64$$, $self$$181$$ = this, $newData$$1$$;
      ...
      this.$collapsibles$.each(function($index$$250$$) {
        $$$$54$$(this).ojCollapsible("option", "expanded") && ($cid$$8$$ = $$$$54$$(this).attr("id"), $result$$65$$.push($cid$$8$$ ? $cid$$8$$ : $index$$250$$));
      });
      ...
      if (Array.isArray($expanded$$11$$)) {
        ...
        this.element.children().each(function($index$$251$$) {
          ($id$$54$$ = $$$$54$$(this).attr("id")) ? -1 != $expanded$$11$$.indexOf($id$$54$$) ? $newExp$$.push($id$$54$$) : -1 != $expanded$$11$$.indexOf($index$$251$$) && $newExp$$.push($id$$54$$) : -1 != $expanded$$11$$.indexOf($index$$251$$) && $newExp$$.push($index$$251$$);
        });
