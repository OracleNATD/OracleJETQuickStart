...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$61$$) {
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.setPage = function $$oj$$61$$$$PagingTableDataSource$$$setPage$($value$$284$$, $options$$337$$) {
    ...
    return new Promise(function($resolve$$51$$, $reject$$48$$) {
      0 < $self$$190$$.$_pageSize$ ? $self$$190$$.$dataSource$.fetch($options$$337$$).then(function($result$$66$$) {
  ...
  $oj$$61$$.$PagingTableDataSource$.prototype.fetch = function $$oj$$61$$$$PagingTableDataSource$$$fetch$($options$$339$$) {
    ...
    return new Promise(function($resolve$$52$$, $reject$$49$$) {
      0 < $pageSize$$6$$ ? $self$$191$$.$dataSource$.fetch($options$$339$$).then(function($result$$67$$) {
        $self$$191$$.$_updateEndIndex$();
        $resolve$$52$$($result$$67$$);
      }, function($e$$100$$) {
        $reject$$49$$($e$$100$$);
      }) : $resolve$$52$$(null);
    });
