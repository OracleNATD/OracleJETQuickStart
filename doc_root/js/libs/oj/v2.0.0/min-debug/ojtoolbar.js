...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$67$$, $$$$62$$) {
  (function() {
    ...
    }, _setOption:function($key$$181$$, $value$$288$$) {
      this._superApply(arguments);
      "disabled" === $key$$181$$ ? $oj$$67$$.$Logger$.warn("Caller attempted to set the 'disabled' option on Toolbar, but Toolbar does not support the 'disabled' option.  See API doc.  Ignoring the call.") : "chroming" === $key$$181$$ && (this.$$buttonsets$.ojButtonset("refresh"), this.$$topLevelButtons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
