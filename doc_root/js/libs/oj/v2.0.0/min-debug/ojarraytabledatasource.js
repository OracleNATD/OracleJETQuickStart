...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$26$$, $$$$24$$) {
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.change = function $$oj$$26$$$$ArrayTableDataSource$$$change$($m$$20$$, $options$$282$$) {
    ...
    this.$_checkDataLoaded$();
    var $silent$$22$$ = $options$$282$$.silent, $i$$316$$, $row$$31$$, $key$$134$$, $changedRow$$, $rowArray$$4$$ = {data:[], keys:[], indexes:[]};
    $m$$20$$ instanceof Array || ($m$$20$$ = [$m$$20$$]);
    for ($i$$316$$ = 0;$i$$316$$ < $m$$20$$.length;$i$$316$$++) {
      $row$$31$$ = $m$$20$$[$i$$316$$], null != $row$$31$$ && ($key$$134$$ = this.$_getId$($row$$31$$), $changedRow$$ = this.$_getInternal$($key$$134$$, null), $rowArray$$4$$.data.push($row$$31$$), $rowArray$$4$$.keys.push($key$$134$$), $rowArray$$4$$.indexes.push($changedRow$$.index), this.$_rows$.data[$changedRow$$.index] = $row$$31$$);
    }
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.sort = function $$oj$$26$$$$ArrayTableDataSource$$$sort$($criteria$$1$$) {
    ...
    "ascending" == $direction$$5$$ ? $comparator$$9$$ = function $$comparator$$9$$$($row$$32$$) {
      return $$$$24$$.isFunction($row$$32$$[$key$$135$$]) ? $row$$32$$[$key$$135$$]() : $row$$32$$[$key$$135$$];
    ...
    return new Promise(function($resolve$$36$$) {
      ...
      if ($self$$147$$.$_hasComparator$()) {
        ...
        $oj$$26$$.$TableDataSource$.$superclass$.handleEvent.call($self$$147$$, $oj$$26$$.$TableDataSource$.$EventType$.SORT, $result$$55$$);
        $resolve$$36$$($result$$55$$);
      }
    });
  };
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_addToRowSet$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_addToRowSet$$($m$$22$$, $index$$188$$, $i$$318_options$$287$$) {
    ...
    for ($i$$318_options$$287$$ = 0;$i$$318_options$$287$$ < $m$$22$$.length;$i$$318_options$$287$$++) {
      if ($row$$33$$ = $m$$22$$[$i$$318_options$$287$$], null != $row$$33$$) {
        $j$$40_key$$136$$ = this.$_getId$($row$$33$$);
        ...
        if (!0 == this.$_sorted$ && 0 < this.$_rows$.data.length) {
          for ($j$$40_key$$136$$ = 0;$j$$40_key$$136$$ < this.$_rows$.data.length;$j$$40_key$$136$$++) {
            if (0 > $oj$$26$$.$ArrayTableDataSource$.$_sortFunc$($row$$33$$, this.$_rows$.data[$j$$40_key$$136$$], this.comparator, this)) {
              this.$_rows$.data.splice($j$$40_key$$136$$, 0, $row$$33$$);
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_getInternal$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_getInternal$$($id$$40$$) {
    var $i$$320$$, $j$$41$$, $row$$34$$, $key$$137$$, $result$$57$$ = null;
    for ($i$$320$$ = 0;$i$$320$$ < this.$_rows$.data.length;$i$$320$$++) {
      if ($row$$34$$ = this.$_rows$.data[$i$$320$$], void 0 !== $row$$34$$) {
        if ($key$$137$$ = this.$_getId$($row$$34$$), $$$$24$$.isArray($key$$137$$) && $$$$24$$.isArray($id$$40$$)) {
          if ($key$$137$$.length == $id$$40$$.length) {
            ...
            $equal$$ && ($result$$57$$ = {data:$row$$34$$, key:$key$$137$$, index:this.$_rows$.indexes[$i$$320$$]});
          }
        } else {
          $key$$137$$ == $id$$40$$ && ($result$$57$$ = {data:$row$$34$$, key:$key$$137$$, index:this.$_rows$.indexes[$i$$320$$]});
        }
      }
    }
    return $result$$57$$;
  ...
  $oj$$26$$.$ArrayTableDataSource$.prototype.$_removeInternal$ = function $$oj$$26$$$$ArrayTableDataSource$$$$_removeInternal$$($m$$23$$, $options$$290$$) {
    var $i$$322$$, $deletedRow_key$$138_row$$35$$;
    ...
    for ($i$$322$$ = 0;$i$$322$$ < $m$$23$$.length;$i$$322$$++) {
      $deletedRow_key$$138_row$$35$$ = $m$$23$$[$i$$322$$], null != $deletedRow_key$$138_row$$35$$ && ($deletedRow_key$$138_row$$35$$ = this.$_getId$($deletedRow_key$$138_row$$35$$), $deletedRow_key$$138_row$$35$$ = this.$_getInternal$($deletedRow_key$$138_row$$35$$, null), null != $deletedRow_key$$138_row$$35$$ && $sortedRowArray$$.push({data:$deletedRow_key$$138_row$$35$$.data, key:$deletedRow_key$$138_row$$35$$.key, index:$deletedRow_key$$138_row$$35$$.index}));
    }
  ...
  $oj$$26$$.$ArrayTableDataSource$.$_sortFunc$ = function $$oj$$26$$$$ArrayTableDataSource$$$_sortFunc$$($a$$110_attrs1$$2$$, $attrs2$$2_b$$67$$, $comparator$$12_i$$325$$, $self$$150$$) {
    var $keyA$$5_retVal$$16$$, $keyB$$5$$;
    if ($$$$24$$.isFunction($comparator$$12_i$$325$$)) {
      if (1 === $comparator$$12_i$$325$$.length) {
        $keyA$$5_retVal$$16$$ = $comparator$$12_i$$325$$.call($self$$150$$, $a$$110_attrs1$$2$$);
        $keyB$$5$$ = $comparator$$12_i$$325$$.call($self$$150$$, $attrs2$$2_b$$67$$);
        ...
        for ($comparator$$12_i$$325$$ = 0;$comparator$$12_i$$325$$ < $a$$110_attrs1$$2$$.length;$comparator$$12_i$$325$$++) {
          if ($keyA$$5_retVal$$16$$ = $oj$$26$$.$ArrayTableDataSource$.$_compareKeys$($a$$110_attrs1$$2$$[$comparator$$12_i$$325$$], $attrs2$$2_b$$67$$[$comparator$$12_i$$325$$], $self$$150$$.direction), 0 !== $keyA$$5_retVal$$16$$) {
            return $keyA$$5_retVal$$16$$;
          }
        }
        return 0;
      }
      return $comparator$$12_i$$325$$.call($self$$150$$, $a$$110_attrs1$$2$$, $attrs2$$2_b$$67$$);
    }
