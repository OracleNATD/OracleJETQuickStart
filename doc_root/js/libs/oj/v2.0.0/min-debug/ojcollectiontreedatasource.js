...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$60$$) {
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$60$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$255$$, $callbacks$$36$$) {
    ...
    if (this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).leaf) {
      ...
      var $collection$$36$$ = this.$treeDataSource$.$GetChildCollection$($model$$78_parentKey$$7$$), $model$$78_parentKey$$7$$ = this.$treeDataSource$.$parseMetadata$($model$$78_parentKey$$7$$).key, $self$$184$$ = this;
  ...
  $oj$$60$$.$CollectionNodeSet$.prototype.getMetadata = function $$oj$$60$$$$CollectionNodeSet$$$getMetadata$($index$$258_model$$79_parse$$6$$) {
    ...
    $metadata$$13$$.key = $index$$258_model$$79_parse$$6$$.key;
    $metadata$$13$$.leaf = $index$$258_model$$79_parse$$6$$.leaf;
    $metadata$$13$$.depth = $index$$258_model$$79_parse$$6$$.depth;
    return $metadata$$13$$;
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$542_model$$81$$, $collection$$38_parents$$5$$, $options$$331$$) {
    ...
    $event$$542_model$$81$$ = this.$_createEvent$(this, "insert", $index$$260$$, $collection$$38_parents$$5$$, this.$_putModelInNodeSet$(null != $collection$$38_parents$$5$$ && 0 < $collection$$38_parents$$5$$.length ? $collection$$38_parents$$5$$[$collection$$38_parents$$5$$.length - 1] : null, $event$$542_model$$81$$));
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$543_model$$82$$, $collection$$39$$, $options$$332$$) {
    ...
    $event$$543_model$$82$$ = this.$_createEvent$(this, "delete", $index$$261$$, this.$_getParentChain$($collection$$39$$), null);
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$544_model$$83$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$544_model$$83$$), $index$$262$$ = null, $parents$$6$$ = null;
    $collectionForModel$$ && ($index$$262$$ = $collectionForModel$$.index, $parents$$6$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$544_model$$83$$ = this.$_createEvent$(this, "update", $index$$262$$, $parents$$6$$, this.$_putModelInNodeSet$(null != $parents$$6$$ && 0 < $parents$$6$$.length ? $parents$$6$$[$parents$$6$$.length - 1] : null, $event$$544_model$$83$$));
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getCacheKey$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getCacheKey$$($model$$85$$) {
    var $key$$163$$ = $model$$85$$ instanceof $oj$$60$$.$Model$ ? this.$parseMetadata$($model$$85$$).key : $model$$85$$;
    return $model$$85$$ ? $key$$163$$ : $oj$$60$$.$CollectionTreeDataSource$.$ROOT_CACHE_KEY$;
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_removeCollectionFromCache$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_removeCollectionFromCache$$($key$$164_model$$88$$) {
    $key$$164_model$$88$$ = this.$_getCacheKey$($key$$164_model$$88$$);
    for (var $prop$$67$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$67$$) && $prop$$67$$ === $key$$164_model$$88$$) {
        this.$cache$[$key$$164_model$$88$$].off(null, null, this);
        delete this.$cache$[$key$$164_model$$88$$];
        break;
      }
    }
  };
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_createEvent$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_createEvent$$($source$$11$$, $operation$$6$$, $index$$263$$, $parent$$40$$, $data$$165$$) {
    return{source:$source$$11$$, operation:$operation$$6$$, index:$index$$263$$, parent:$parent$$40$$, data:$data$$165$$};
  };
    ...
    return new Promise(function($resolve$$49$$) {
      function $checkNext$$($index$$264$$, $collection$$52$$, $key$$168$$) {
        $index$$264$$ < $collection$$52$$.length ? $collection$$52$$.at($index$$264$$, {deferred:!0}).then(function($model$$90$$) {
          if ($model$$90$$) {
            var $parse$$7$$ = $self$$187$$.$parseMetadata$($model$$90$$);
  ...
  $oj$$60$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$60$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$53$$, $key$$169$$, $depth$$25$$) {
    ...
    return new Promise(function($resolve$$50$$) {
      $self$$188$$.$_scanForKey$($collection$$53$$, $key$$169$$).then(function($model$$91$$) {
          ...
          if ($index$$265$$ < $max$$9$$) {
            ...
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$169$$, $depth$$25$$ + 1).then(function($childModel$$) {
                $childModel$$ ? $resolve$$50$$($childModel$$) : ($index$$265$$++, $getNextCollection$$($index$$265$$, $tds$$));
              });
        ...
        if ($model$$91$$) {
          $resolve$$50$$({$model$:$model$$91$$, depth:$depth$$25$$});
        } else {
